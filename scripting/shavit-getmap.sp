...
void OnMapFileDownloaded(HTTPStatus status, DataPack data)
{
	...
	if(status != HTTPStatus_OK)
	{
		...
		Shavit_PrintToChat(client, "%sFailed to download %s%s%s: HTTPStatus (%s%d%s)", gS_ChatStrings.sText, gS_ChatStrings.sVariable, mapName, gS_ChatStrings.sText, gS_ChatStrings.sVariable, status, gS_ChatStrings.sText);
